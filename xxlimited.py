...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7f43cf68ac50>'

__spec__ = None # (!) real value is "ModuleSpec(name='xxlimited', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7f43cf68ac50>, origin='/usr/lib/python3.6/lib-dynload/xxlimited.cpython-36m-x86_64-linux-gnu.so')"
