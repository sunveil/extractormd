...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc2c8861c18>'

__spec__ = None # (!) real value is "ModuleSpec(name='termios', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc2c8861c18>, origin='/usr/lib/python3.6/lib-dynload/termios.cpython-36m-x86_64-linux-gnu.so')"
