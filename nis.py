...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc59b0a2c18>'

__spec__ = None # (!) real value is "ModuleSpec(name='nis', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fc59b0a2c18>, origin='/usr/lib/python3.6/lib-dynload/nis.cpython-36m-x86_64-linux-gnu.so')"
