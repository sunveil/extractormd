...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd445a5fc50>'

__spec__ = None # (!) real value is "ModuleSpec(name='_testbuffer', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7fd445a5fc50>, origin='/usr/lib/python3.6/lib-dynload/_testbuffer.cpython-36m-x86_64-linux-gnu.so')"
