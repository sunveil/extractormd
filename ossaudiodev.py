...
__loader__ = None # (!) real value is '<_frozen_importlib_external.ExtensionFileLoader object at 0x7efea22f2fd0>'

__spec__ = None # (!) real value is "ModuleSpec(name='ossaudiodev', loader=<_frozen_importlib_external.ExtensionFileLoader object at 0x7efea22f2fd0>, origin='/usr/lib/python3.6/lib-dynload/ossaudiodev.cpython-36m-x86_64-linux-gnu.so')"
